...
namespace garlic
{
    ...
    GarlicRoutingSession (GarlicDestination * owner, std::shared_ptr<const i2p::data::RoutingDestination> destination,
			...
			virtual std::shared_ptr<GarlicRoutingPath> GetSharedRoutingPath ();

    void VisitSharedRoutingPath(std::function<void(std::shared_ptr<GarlicRoutingPath>)> v) { v(m_SharedRoutingPath); };
			void SetSharedRoutingPath (std::shared_ptr<GarlicRoutingPath> path);
    bool HasSharedRoutingPath() { return m_SharedRoutingPath != nullptr; };
  ...
  typedef std::function<void(GarlicRoutingSessionPtr)> GarlicRoutingSessionVisitor;
	...
	class GarlicDestination: public i2p::data::LocalDestination
	{
		public:
			...
			virtual GarlicRoutingSessionPtr GetRoutingSession (std::shared_ptr<const i2p::data::RoutingDestination> destination, bool attachLeaseSet);
    ...
    virtual GarlicRoutingSessionPtr CreateNewRoutingSession(std::shared_ptr<const i2p::data::RoutingDestination> destination, int numTags, bool attachLeaseSet);

    void VisitAllRoutingSessions(GarlicRoutingSessionVisitor v);
