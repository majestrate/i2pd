...
namespace config {
  ...
  void Init() {
    ...
    general.add_options()
      ...
      ("ipv6",      value<bool>()->zero_tokens()->default_value(true),  "Enable communication through ipv6")
      ("ipv4",      value<bool>()->zero_tokens()->default_value(false), "Enable communication through ipv4")
