...
namespace client
{
    ...
    // for recv from
    boost::asio::ip::udp::endpoint RecvFromEndpoint;
		...
		UDPSession(boost::asio::ip::udp::endpoint socket_ep,
               const std::shared_ptr<i2p::client::ClientDestination> & localDestination,
							 boost::asio::ip::udp::endpoint remote, const i2p::data::IdentHash * ident,
							 uint16_t ourPort, uint16_t theirPort);

		UDPSession(const std::shared_ptr<i2p::client::ClientDestination> & localDestination,
							 boost::asio::ip::udp::endpoint remote, const i2p::data::IdentHash * ident,
							 uint16_t ourPort, uint16_t theirPort);
	...
	class I2PUDPServerTunnel
  {
    ...
    uint16_t GetNextPort(const boost::asio::ip::udp::endpoint & ep);
    
			const std::string m_Name;
    
      std::mutex m_SessionsMutex;
      std::map<uint16_t, UDPSessionPtr> m_Sessions;
