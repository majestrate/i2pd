...
namespace client
{
    ...
    options[I2CP_PARAM_TUNNEL_LATENCY_MIN] = GetI2CPOption (section, I2CP_PARAM_TUNNEL_LATENCY_MIN, DEFAULT_TUNNEL_LATENCY_MIN);
    options[I2CP_PARAM_TUNNEL_LATENCY_MAX] = GetI2CPOption (section, I2CP_PARAM_TUNNEL_LATENCY_MAX, DEFAULT_TUNNEL_LATENCY_MAX);
    options[I2CP_PARAM_TUNNEL_KEY_LIFESPAN] = GetI2CPOption (section, I2CP_PARAM_TUNNEL_KEY_LIFESPAN, 0);
	}	
